...
const ConferenceEvent = () => {
  ...
  // Added code here to create logic for listing items
  ...
  const calculateTotalCost = (section) => {
    ...
    if (section === "venue") {
      ...
      // Added an extra condition for when the audio-visual tools are selected
    } else if (section === 'av') {
      avItems.forEach((item) => {
        totalCost += item.cost * item.quantity;
      })
                  ...
                  {avItems.map((item, index) => (
                    <div className="av_data venue_main" key={index}>
                      ...
                      <div className="addons_btn">
                        ...
                        <button className=" btn-success" onClick={() => handleIncrementAvQuantity(index)}> &#43; </button></div>
                  ...
                  {mealsItems.map((item, index) => (
                    <div className="meal_item" key={index} style={{ padding: 15 }}>
                      <div className="inner">
                        ...
                        <label htmlFor={`meal_cost${index}`}> {item.name} </label>
                      </div>
